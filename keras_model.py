...
class Code2VecModel(Code2VecModelBase):
    ...
    def predict(self, predict_data_rows: Iterable[str]) -> List[ModelPredictionResults]:
        ...
        for input_row in input_iterator:
            ...
            # print('SSSSSSSSSSSSSSSSSSSSS'*50)
        ...
        # print('AAAA'*50)
        # print(all_model_prediction_results)
        # print('AAAA'*50)
    ...
    def _save_inner_model(self, path):
        if self.config.RELEASE:
            ...
            self.keras_train_model.save(path + '/model.h5')
    ...
    def _load_inner_model(self):
        ...
        self.keras_train_model.load_weights(self.config.entire_model_load_path + '/mutants/'+ '/WGF_input_0.05_0_0.1_100.h5')
        self.keras_train_model.summary(print_fn=self.log)
        print('vesalk')
